...
namespace ModeloNavigation.UI.ViewModels
{
    public class MasterPageViewModel : BaseViewModel
    {
        ...
        void PopulateMaster()
        {
            try
            {
                var pages = new[]
                {
                    new PageType { Name = "Page 1", TypePage = ViewModelType.UmViewModel},
                    new PageType { Name = "Page 2", TypePage = ViewModelType.DoisViewModel},
                };
